...
MainGLWidget::MainGLWidget(QWidget *parent)
    ...
    GLuint MainGLWidget::makeObject()
    {
    ...
    void MainGLWidget::quad(GLdouble x1, GLdouble y1, GLdouble x2, GLdouble y2,
    ...
    void MainGLWidget::extrude(GLdouble x1, GLdouble y1, GLdouble x2, GLdouble y2)
    {
    ...
    void MainGLWidget::normalizeAngle(int *angle)
    {
        while (*angle < 0)
            *angle += 360 * 16;
        while (*angle > 360 * 16)
