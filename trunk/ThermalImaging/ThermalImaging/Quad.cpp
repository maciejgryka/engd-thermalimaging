...
void Quad::drawQuad() {
	if (empty) {
		...
		glVertex3f(boundaries[0],-0.1f,boundaries[1]);
		glVertex3f(boundaries[2],-0.1f,boundaries[1]);
		glVertex3f(boundaries[2],-0.1f,boundaries[3]);
		glVertex3f(boundaries[0],-0.1f,boundaries[3]);
